...
wget "https://github.com/SmartCash/Core-Smart/releases/download/v2.0.1/smartcash-2.0.1-x86_64-linux-gnu.tar.gz" -O - | tar -xz
...
cp smartcash-2.0.1/bin/smartcash-cli ~/ && sleep 1
