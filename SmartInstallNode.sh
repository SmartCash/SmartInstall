...
cp smartcash-2.0.5/bin/smartcash-cli ~/ && sleep 1
...
#ln -sf ~/smartcash-2.0.5/bin/smartcashd /usr/bin/smartcashd
#ln -sf ~/smartcash-2.0.5/bin/smartcash-cli /usr/bin/smartcash-cli
