...
wget "https://github.com/SmartCash/Core-Smart/releases/download/v2.0.2/smartcash-1.3.4-x86_64-linux-gnu.tar.gz" -O - | tar -xz

# Extract the files and give executable permissions
echo 'Copying files to home directory'
cp smartcash-2.0.2/bin/smartcashd ~/
cp smartcash-2.0.2/bin/smartcash-cli ~/
