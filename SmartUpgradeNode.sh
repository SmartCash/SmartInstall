...
test -f ~/smartcash-cli && ~/smartcash-cli stop && sleep 20 && rm ~/smartcashd && rm ~/smartcash-cli && sleep 1
test -f /usr/bin/smartcash-cli && smartcash-cli stop && sleep 20 && echo 'Please remove the old smartcashd with apt remove smartcashd' && sleep 1
